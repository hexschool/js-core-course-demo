...
(function(global, factory) {
  ...
  Dep.prototype.notify = function notify() {
    ...
    console.dir('02 Dep notify', subs[0].update);
  };
  ...
  function defineReactive$$1(obj, key, val, customSetter, shallow) {
    ...
    Object.defineProperty(obj, key, {
      ...
      get: function reactiveGetter() {
        console.log('reactiveGetter', this);
      ...
      set: function reactiveSetter(newVal) {
        console.log('01 reactiveSetter', newVal, this);
        var value = getter ? getter.call(obj) : val;
        ...
        console.log('01 reactiveSetter', obj, key, newVal);
        dep.notify();
      }
    });
  }
  ...
  Watcher.prototype.get = function get() {
    ...
    try {
      ...
      console.log('04 Watcher popTarget');
      popTarget();
      this.cleanupDeps();
    }
    return value;
  ...
  Watcher.prototype.run = function run() {
    console.log('03 Watcher.prototype.run', this);
    if (this.active) {
      var value = this.get();
      if (
        value !== this.value ||
